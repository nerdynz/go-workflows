ALTER TABLE "activities" ADD COLUMN "attributes" BYTEA NULL;
...
ALTER TABLE "history" ADD COLUMN "attributes" BYTEA NULL;
...
ALTER TABLE "pending_events" ADD COLUMN "attributes" BYTEA NULL;
