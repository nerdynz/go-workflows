ALTER TABLE activities ADD COLUMN IF NOT EXISTS attributes BYTEA;
...
ALTER TABLE history ADD COLUMN IF NOT EXISTS attributes BYTEA;
...
ALTER TABLE pending_events ADD COLUMN IF NOT EXISTS attributes BYTEA;
